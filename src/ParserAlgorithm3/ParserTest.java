...
public class ParserTest {
    ...
    public void testMoreNumbers() {
        assertTrue(new Parser(new Tokeniser("446325")).parseExp());
		...
		assertFalse(new Parser(new Tokeniser("363433")).parseExp());				

        assertTrue(new Parser(new Tokeniser("353618")).parseExp());
		...
		assertFalse(new Parser(new Tokeniser("2322")).parseExp());		
    }

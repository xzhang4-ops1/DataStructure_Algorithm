...
public class BinarySearchTest {
    ...
    public void beforeTest() {
        ...
        for (int i = 0; i < 10; i++) {
            for (int j = 0; j < 10; j++) {
                for (int k = 0; k < 10; k++) {
                    testMatrix[i][j][k] = new Element<Integer>(_key, _key + 1);
                    _key++;
                }
            }
        }
        ...
        public void Test1 () {
            ...
            Element<Integer> actual1 = bs.search(testMatrix, 0, 9, 0, 9, 0, 9, 1);
        ...
        @Test(timeout = 1000)
        public void Test2 () {
            Element<Integer> expected2 = new Element<Integer>(100, 101);
            Element<Integer> actual2 = bs.search(testMatrix, 0, 9, 0, 9, 0, 9, 100);
        ...
        @Test(timeout = 1000)
        public void Test3 () {
            Element<Integer> expected3 = new Element<Integer>(320, 321);
            Element<Integer> actual3 = bs.search(testMatrix, 0, 9, 0, 9, 0, 9, 320);
        ...
        @Test(timeout = 1000)
        public void Test4 () {
            Element<Integer> expected4 = new Element<Integer>(576, 577);
            Element<Integer> actual4 = bs.search(testMatrix, 0, 9, 0, 9, 0, 9, 576);
